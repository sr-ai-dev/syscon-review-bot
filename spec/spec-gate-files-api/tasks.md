...
- [x] spec 문서 규칙을 `tasks.md` 필수 + `requirements.md` 또는 `design.md` 중 1개 이상으로 변경했다.
...
- PR #265에는 `spec/260521-기능통합/requirements.md`와 `spec/260521-기능통합/tasks.md`가 있으므로 현재 spec gate 규칙을 만족한다.
- PR #265의 `spec/260521-기능통합/disign.md`는 오타가 있지만, `tasks.md`가 있고 `requirements.md`가 보조 문서 요건을 만족하므로 gate는 통과한다.
